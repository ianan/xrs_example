...
# Also has previous version using older CHIANTI v7, GOES15, Coronal abundances only at the end
# 
...
# -------------------------------
#  Versions using older CHIANTI v9, coronal and GOES15 only
# -----------------------------
def get_resprat_old():
